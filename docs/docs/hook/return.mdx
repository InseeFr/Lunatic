...
### Les méthodes
  ...
  -	getChangedData, permet de récupérer les données qui ont changées (cf [section "suivi des changements"](./parameters#vue-densemble))
  -	resetChangedData, vide le dictionnaire des variables changée (cf [section "suivi des changements"](./parameters#vue-densemble))
