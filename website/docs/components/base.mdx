...
Les contrôles n'ont aucun effet dans Lunatic directement, c'est à l'orchestrateur d'agir comme il le souhaite en utilisant la méthode `compileControls()` [cf](../hook/controls.mdx).

:::

import sourceControls from '../../../src/stories/behaviour/controls/source-simple.json';
