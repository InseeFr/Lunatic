...
Dans le cadre des liens 2 à 2 / pariwise :

- **GLOBAL_PARENT1_PRENOM** (string), permet d'utiliser le prénom du premier parent défini dans les liens 2 à 2
- **GLOBAL_PARENT1_SEXE** (string), permet d'utiliser le genre du premier parent défini dans les liens 2 à 2 : "1" est homme, "2" est femme
- **GLOBAL_PARENT2_PRENOM** (string), permet d'utiliser le prénom du deuxième parent défini dans les liens 2 à 2
- **GLOBAL_PARENT2_SEXE** (string), permet d'utiliser le genre du deuxième parent défini dans les liens 2 à 2 : "1" est homme, "2" est femme
- **GLOBAL_CONJOINT_PRENOM** (string), permet d'utiliser le prénom du conjoint défini dans les liens 2 à 2
- **GLOBAL_ENFANTS_PRENOMS** (string), permet d'utiliser les prénoms des enfants définis dans les liens 2 à 2 : il s'agit d'une chaîne de caractère des prénoms séparés par un `;`
