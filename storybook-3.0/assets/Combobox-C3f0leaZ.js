...
| 'STATEMENT'`,elements:[{name:"literal",value:"'INSTRUCTION'"},{name:"literal",value:"'COMMENT'"},{name:"literal",value:"'HELP'"},{name:"literal",value:"'CODECARD'"},{name:"literal",value:"'WARNING'"},{name:"literal",value:"'STATEMENT'"}],required:!0}},{key:"position",value:{name:"string",required:!0}},{key:"label",value:{name:"ReactNode",required:!0}}]}}],raw:`{
	...
	position: string;
	label: ReactNode;
}[]`},description:""}}};const H="";function ye({className:e,classNamePrefix:n,classStyle:r="default-style",placeholder:i="Commencez votre saisie...",editable:t=!1,disabled:a,readOnly:s,id:l,optionRenderer:b,labelRenderer:d,onChange:c,onSelect:m,value:y,options:v,messageError:k,search:R=H,getOptionValue:w=Ke,label:j,description:E,declarations:fe,errors:B,onBlur:T,onFocus:I,isLoading:ge}){const[M,C]=p.useState(!1),[S,P]=p.useState(!1),L=Qe(v,y,w),G=`label-${l}`,ve=()=>{a||s||(I==null||I(),C(!0),P(!0))},Te=()=>{a||s||(C(!1),P(!1),T==null||T())},x=(q,O=!0)=>{const _=We($e(q),0,v.length),Ne=v[_];O&&(C(!1),T==null||T()),m(w(Ne))},Ce=q=>{c==null||c(q)},xe=()=>{C(!1),c==null||c(H),m(null)},qe=q=>{const O=v.length;switch(q){case g.Tab:case g.Escape:C(!1);return;case g.ArrowDown:x((L??-1)+1,!1);return;case g.ArrowUp:x((L??O)-1,!1);return;case g.Home:x(0,!1);return;case g.End:x(O-1,!1);return;case g.Enter:C(_=>!_);return}},he=!a||!s;return k?o.jsx("div",{className:"lunatic-combo-box-message-error",children:k}):o.jsxs(z,{id:l,className:e,classStyle:r,classNamePrefix:n,errors:B,children:[o.jsx(He,{htmlFor:l,id:G,description:E,children:j}),o.jsx(Xe,{type:"AFTER_QUESTION_TEXT",declarations:fe}),o.jsxs(Z,{focused:S,onFocus:ve,onBlur:Te,onKeyDown:qe,classNamePrefix:n,children:[o.jsx(de,{labelRenderer:d,placeholder:i,search:R,expanded:M,id:l,labelId:G,disabled:a,readOnly:s,focused:S,editable:t,selectedIndex:L,options:v,onChange:Ce,classNamePrefix:n,invalid:!!B}),o.jsx(te,{isLoading:ge,optionRenderer:b,options:v,focused:S,selectedIndex:L,expanded:M,id:l,search:R,onSelect:x})]}),he&&o.jsx(Me,{className:u({focused:S}),search:y,onClick:xe,editable:t})]})}function Qe(e,n,r){if(Array.isArray(e))return e.map(r).findIndex(i=>i===n)}function Ke(e={value:""}){const{id:n,value:r}=e;return n||r}const rn=f("Combobox",ye);ye.__docgenInfo={description:"",methods:[],displayName:"LunaticComboBox",props:{expanded:{required:!1,tsType:{name:"boolean"},description:""},focused:{required:!1,tsType:{name:"boolean"},description:""},onChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(s: string | null) => void",signature:{arguments:[{type:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}]},name:"s"}],return:{name:"void"}}},description:""},editable:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},labelId:{required:!1,tsType:{name:"string"},description:""},id:{required:!1,tsType:{name:"string"},description:""},classNamePrefix:{required:!1,tsType:{name:"string"},description:""},readOnly:{required:!1,tsType:{name:"boolean"},description:""},invalid:{required:!1,tsType:{name:"boolean"},description:""},labelRenderer:{required:!1,tsType:{name:"ComponentType",elements:[{name:"signature",type:"object",raw:`{
	option?: ComboboxOptionType;
	placeholder?: string;
	search?: string;
	disabled?: boolean;
