...
export type LunaticState = {
	...
	// TODO replace with  overviewEntryType[]
	overview: OverviewSeq[];
};

export type OverviewSubseq = {
	id: string;
	page: string;
	type: string;
